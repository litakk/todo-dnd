          ...
          {section.data ? (
            <div className="space-y-1 text-gray-700">
              {section.key === "expirience" && (
                <>
                  <p>
                    <strong>Должность:</strong> {section.data["должность"]}
                  </p>
                  <p>
              ...
              {section.key === "education" && (
                <>
                  ...
                  <p>
                    <strong>Годы обучения:</strong> {section.data["год начала"]}{" "}
              ...
              {section.key === "about-me" && (
                <>
                  <p>
                    <strong>Описание:</strong> {section.data["aboutPerson"]}
                  </p>
                  <p>
                    <strong>Языки:</strong> {section.data["language"]}
                  </p>
                  <p>
                    <strong>Местоположение:</strong> {section.data["location"]}
                  </p>
                </>
              )}
              <Button
